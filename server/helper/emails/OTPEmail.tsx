        ...
        <Preview>Reset Password</Preview>
            <Body style={main}>
                ...
                <Text style={codeDescription}>
                    Press the Reset button to proceed with the password reset.
                    And enter it in your open browser window.
                ...
                <Button href={`${DOMAIN_NAME}/auth/reset-password`} style={button}>
                    Reset Password
                    </Button>
                    </Section>
